...
export default function EditListing() {
    ...
    const params =useParams()
        ...
        // check if listing is edited by person who wrote it
        useEffect(()=>{
    ...
    async function onSubmit(e){
        ...
        if(images.length > 6){
            setLoading(false)
            toast.error ("Maximum allowed images are 6")
            return;
        }
  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form onSubmit={onSubmit}>
            ...
            minLength="10" 
            required 
            className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-500 focus:bg-white focus:border-slate-600 mb-6'/>
            <div className='flex space-x-6 mb-6'>
                <div>
                    ...
                    max="50" 
                    required 
                    className='w-full px-4 py-2 text-xl test-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
                </div>
                <div>
            ...
            <button type='submit' className='mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-800 focus:shadow-lg active:bg-blue-900 active:shadow-lg transition duration-150 ease-in-out'>
                Edit Listing
            </button>
        </form>
    </main>
